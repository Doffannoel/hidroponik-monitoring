  ...
  history: [
    {
      ...
      description: "Added 2.5L RO water with adjusted A+B nutrient blend.",
    ...
    },
    {
      ...
      description:
        "Delayed dark cycle by 1 hour to synchronize with peak harvest window.",
    ...
    },
    {
      ...
      description:
        "Removed lower fan leaves to improve airflow and vertical light penetration.",
